...
{!!Form::open(array('url'=>'admin/sconti/quantita/'.$scontoquantita->id,'method'=>'PUT'))!!}
<div class="row">
    <div class="col-md-4 col-md-offset-2">
        <div class="form-group">
            {!! Form::label('quantita_min', Lang::choice('messages.dash_sconti_quantita_create_quantita_minima',0)) !!}
            {!! Form::text('quantita_min', $scontoquantita->quantita_min, array('class'=>'form-control')) !!}
        </div>
    </div>
</div>
...
<div class="row">
    <div class="col-md-4 col-md-offset-2">
        <div class="form-group">
            ...
            {!! Form::text('quantita_max', $scontoquantita->quantita_max, array('class'=>'form-control')) !!}
        </div>
    </div>
</div>
...
<div class="row">
    <div class="col-md-8 col-md-offset-2">
        <div class="form-group">
            {!! Form::submit(Lang::choice('messages.dash_sconti_quantita_edit_pulsante_modifica',0), array('class' =>'btn btn-success'))!!}
        </div>
    </div>
</div>
{!!Form::close()!!}

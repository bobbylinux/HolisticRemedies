...
<table class="table table-hover table-responsive">
    <thead>
        <tr>
            ...
            <th class="col-lg-2">{{ Lang::choice('messages.dash_clienti_index_attivo',0) }}</th>
            <th class="col-lg-2">{{ Lang::choice('messages.dash_clienti_index_ruolo',0) }}</th>
    ...
    <tbody>
        ...
        <tr>
            ...
            <td class="col-lg-2">{!! Lang::choice('messages.si',0) !!}</td>
            @else
            <td class="col-lg-2">{!! Lang::choice('messages.no',0) !!}</td>
            @endif

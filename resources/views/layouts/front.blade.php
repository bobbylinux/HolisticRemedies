                ...
                <div class="collapse navbar-collapse navbar-ex1-collapse">
                    ...
                    <ul class="nav navbar-nav navbar-right">
                        ...
                        <li class="dropdown hidden-xs hidden-sm">
                            <a href="#" class="dropdown-toggle" data-toggle="dropdown" role="button" aria-haspopup="true" aria-expanded="false"><i class="fa fa-fw fa-user"></i> {!! Lang::choice('messages.menu_accedi',0) !!}<span class="caret"></span></a>
                        ...
                        <li><a href="https://www.facebook.com/CaisseFormula/"  target="_blank"><i class="fa fa-facebook"></i><span class="hidden-sm"> FACEBOOK</span></a></li>
                        @if (App::getLocale() == "en")
                        <li><a href="{!! url('lang/it') !!}"><span class="flag-icon flag-icon-it"></span><span class="hidden-sm"> {{ Config::get('languages')[App::getLocale()] }}</span></a></li>                        
                        @elseif (App::getLocale() == "it")
                        <li><a href="{!! url('lang/en') !!}"><span class="flag-icon flag-icon-gb"></span><span class="hidden-sm"> {{ Config::get('languages')[App::getLocale()] }}</span></a></li>     
                        @endif
                    </ul>
